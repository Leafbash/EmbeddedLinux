...
static unsigned int gpioLED = 115;       ///< hard coding the LED gpio for this example to P9_27 (GPIO115)
static unsigned int gpioButton = 113;   ///< hard coding the button gpio for this example to P9_28 (GPIO113)
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        "ebb_gpio_handler_off",    // Used in /proc/interrupts to identify the owner
